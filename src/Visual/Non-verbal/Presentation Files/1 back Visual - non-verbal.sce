scenario = "1 back Visual - non-verbal";
...
write_codes = false; 
pulse_width = 10;
pcl_file = "1 back Visual - non-verbal.pcl";
begin;
#loading stimuli
...
trial{ #this is the first screen to prepare people 
  trial_duration = forever;        	# trial lasts until target
   ...
   picture {
		text {font_size=25; font="Arial"; caption ="Please press the LEFT ctrl if the square shows up at the same place as the previous time \n \n Please press the RIGHT ctrl after you see the square anywhere else \n \n \n \n press the left ctrl to continue"; font_color = 200,200,200;};
      x=0;y=0;};
}instruction_trial;
